...
import { User, Bell, Shield, Palette, Database, ArrowLeft } from "lucide-react";
...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <Sidebar />
      {/* Main content with proper left margin to avoid sidebar overlap */}
